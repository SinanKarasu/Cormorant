    ...
    set {
      ...
      if let newValue = newValue {
        ...
        precondition(valuesToKeys[newValue] == key || valuesToKeys[newValue] == nil,
          "New value is already associated with a different key: \(valuesToKeys[newValue] as Any)")
    ...
    set(newKey) {
      ...
      if let newKey = newKey {
        ...
        precondition(keysToValues[newKey] == value || keysToValues[newKey] == nil,
          "New key is already associated with a different value: \(keysToValues[newKey] as Any)")
...
final class InternedValueStore {
  ...
  func internedKeyword(for name: InternedConstant) -> InternedKeyword {
    return InternedKeyword(symbol: InternedSymbol(internedString(for: name)))
  }
