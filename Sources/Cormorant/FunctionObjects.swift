...
/// An opaque class describing a user-defined Cormorant function or macro.
public final class Function {
  ...
  static func buildFunction(arities: [SingleFn], name: UnqualifiedSymbol?, ctx: Context, asMacro: Bool) -> EvalResult {
  ...
  func evaluate(arguments: Params) -> EvalResult {
    ...
    else if let varargFunction = variadic, arguments.count >= varargFunction.paramCount {
